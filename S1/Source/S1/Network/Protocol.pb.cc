...
PROTOBUF_CONSTEXPR S_DESPAWN::S_DESPAWN(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.objedct_ids_)*/{}
  , /*decltype(_impl_._objedct_ids_cached_byte_size_)*/{0}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
PROTOBUF_CONSTEXPR C_SAVE::C_SAVE(
    ::_pbi::ConstantInitialized) {}
struct C_SAVEDefaultTypeInternal {
  PROTOBUF_CONSTEXPR C_SAVEDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~C_SAVEDefaultTypeInternal() {}
  union {
    C_SAVE _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 C_SAVEDefaultTypeInternal _C_SAVE_default_instance_;
PROTOBUF_CONSTEXPR S_SAVE::S_SAVE(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.info_)*/nullptr
  , /*decltype(_impl_.object_id_)*/uint64_t{0u}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct S_SAVEDefaultTypeInternal {
  PROTOBUF_CONSTEXPR S_SAVEDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~S_SAVEDefaultTypeInternal() {}
  union {
    S_SAVE _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 S_SAVEDefaultTypeInternal _S_SAVE_default_instance_;
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_DESPAWN, _impl_.objedct_ids_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_SAVE, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_SAVE, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_SAVE, _impl_.object_id_),
  PROTOBUF_FIELD_OFFSET(::Protocol::S_SAVE, _impl_.info_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 69, -1, -1, sizeof(::Protocol::C_SAVE)},
  { 75, -1, -1, sizeof(::Protocol::S_SAVE)},
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::Protocol::_C_SAVE_default_instance_._instance,
  &::Protocol::_S_SAVE_default_instance_._instance,
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 591, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
...
S_DESPAWN::S_DESPAWN(const S_DESPAWN& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.objedct_ids_){from._impl_.objedct_ids_}
    , /*decltype(_impl_._objedct_ids_cached_byte_size_)*/{0}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void S_DESPAWN::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.objedct_ids_){arena}
    , /*decltype(_impl_._objedct_ids_cached_byte_size_)*/{0}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void S_DESPAWN::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.objedct_ids_.~RepeatedField();
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedUInt64Parser(_internal_mutable_objedct_ids(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<uint8_t>(tag) == 8) {
          _internal_add_objedct_ids(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* S_DESPAWN::_InternalSerialize(
  ...
  // repeated uint64 objedct_ids = 1;
  {
    int byte_size = _impl_._objedct_ids_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteUInt64Packed(
          1, _internal_objedct_ids(), byte_size, target);
    }
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_DESPAWN)
  ...
  // repeated uint64 objedct_ids = 1;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      UInt64Size(this->_impl_.objedct_ids_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._objedct_ids_cached_byte_size_.store(cached_size,
...
void S_DESPAWN::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.objedct_ids_.MergeFrom(from._impl_.objedct_ids_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void S_DESPAWN::InternalSwap(S_DESPAWN* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.objedct_ids_.InternalSwap(&other->_impl_.objedct_ids_);
}
...
class C_SAVE::_Internal {
 public:
};

C_SAVE::C_SAVE(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase(arena, is_message_owned) {
  // @@protoc_insertion_point(arena_constructor:Protocol.C_SAVE)
}
C_SAVE::C_SAVE(const C_SAVE& from)
  : ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase() {
  C_SAVE* const _this = this; (void)_this;
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:Protocol.C_SAVE)
}
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData C_SAVE::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl,
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeImpl,
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*C_SAVE::GetClassData() const { return &_class_data_; }
...
::PROTOBUF_NAMESPACE_ID::Metadata C_SAVE::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Protocol_2eproto_getter, &descriptor_table_Protocol_2eproto_once,
...
class S_SAVE::_Internal {
 public:
  static const ::Protocol::SaveInfo& info(const S_SAVE* msg);
};

const ::Protocol::SaveInfo&
S_SAVE::_Internal::info(const S_SAVE* msg) {
  return *msg->_impl_.info_;
}
void S_SAVE::clear_info() {
  if (GetArenaForAllocation() == nullptr && _impl_.info_ != nullptr) {
    delete _impl_.info_;
  }
  _impl_.info_ = nullptr;
}
S_SAVE::S_SAVE(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.S_SAVE)
}
S_SAVE::S_SAVE(const S_SAVE& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  S_SAVE* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.info_){nullptr}
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_info()) {
    _this->_impl_.info_ = new ::Protocol::SaveInfo(*from._impl_.info_);
  }
  _this->_impl_.object_id_ = from._impl_.object_id_;
  // @@protoc_insertion_point(copy_constructor:Protocol.S_SAVE)
}

inline void S_SAVE::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
S_SAVE::~S_SAVE() {
  // @@protoc_insertion_point(destructor:Protocol.S_SAVE)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void S_SAVE::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.info_;
}

void S_SAVE::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void S_SAVE::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.S_SAVE)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* S_SAVE::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* S_SAVE::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.S_SAVE)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.S_SAVE)
  return target;
}

size_t S_SAVE::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_SAVE)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData S_SAVE::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    S_SAVE::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*S_SAVE::GetClassData() const { return &_class_data_; }


void S_SAVE::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<S_SAVE*>(&to_msg);
  auto& from = static_cast<const S_SAVE&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.S_SAVE)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_has_info()) {
    _this->_internal_mutable_info()->::Protocol::SaveInfo::MergeFrom(
        from._internal_info());
  }
...
void S_SAVE::CopyFrom(const S_SAVE& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.S_SAVE)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool S_SAVE::IsInitialized() const {
  return true;
}

void S_SAVE::InternalSwap(S_SAVE* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(S_SAVE, _impl_.object_id_)
      + sizeof(S_SAVE::_impl_.object_id_)
      - PROTOBUF_FIELD_OFFSET(S_SAVE, _impl_.info_)>(
          reinterpret_cast<char*>(&_impl_.info_),
          reinterpret_cast<char*>(&other->_impl_.info_));
}

::PROTOBUF_NAMESPACE_ID::Metadata S_SAVE::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Protocol_2eproto_getter, &descriptor_table_Protocol_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::Protocol::C_SAVE*
Arena::CreateMaybeMessage< ::Protocol::C_SAVE >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::C_SAVE >(arena);
}
template<> PROTOBUF_NOINLINE ::Protocol::S_SAVE*
Arena::CreateMaybeMessage< ::Protocol::S_SAVE >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::S_SAVE >(arena);
}
